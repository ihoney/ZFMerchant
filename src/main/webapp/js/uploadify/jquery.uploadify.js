        ...
        "init": function(options, swfUploadOptions) {
            return this.each(function() {
                var $this = $(this), $clone = $this.clone(), settings = $.extend({
                    ...
                    "uploader": "api/index/fileupload",
                    "auto": true,
                    "buttonClass": "informImg_a",
                    "buttonCursor": "hand",
                    //"buttonImage": "images/upload_btn.jpg",
                    "buttonText": "上传照片",
                    "checkExisting": !1,
                    "debug": !1,
                    "fileObjName": "file",
                    "fileSizeLimit": '2MB',
                    "fileTypeDesc": "*.jpg;*.png;*.gif;*.bmp;*.jpeg;*.JPG;*.PNG;*.GIF;*.BMP;*.JPEG",
                    "fileTypeExts": "*.jpg;*.png;*.gif;*.bmp;*.jpeg;*.JPG;*.PNG;*.GIF;*.BMP;*.JPEG",
                    "height": 30,
                    "itemTemplate": !1,
                    "method": "post",
                    "multi": false,
...
//            this.queueData.errorMsg = "Some files were not added to the queue:", this.queueData.filesReplaced = 0, this.queueData.filesCancelled = 0, settings.onDialogOpen && settings.onDialogOpen.call(this);
            this.queueData.errorMsg = "上传失败！", this.queueData.filesReplaced = 0, this.queueData.filesCancelled = 0, settings.onDialogOpen && settings.onDialogOpen.call(this);
        },
...
//                this.queueData.errorMsg += '\nThe file "' + file.name + '" exceeds the size limit (' + settings.fileSizeLimit + ").";
              ...
              case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
                this.queueData.errorMsg += '  上传文件为空';
                break;
              case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
                this.queueData.errorMsg += ' 文件格式不支持' ;
