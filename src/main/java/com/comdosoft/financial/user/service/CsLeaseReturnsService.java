...
//        logger.debug("one_d==="+one_d+"===>>>two_d=="+two_d);
        ...
        map.put("receiver_name", o.get("contact")==null?"":o.get("contact"));
        map.put("receiver_phone", o.get("phone") ==null?"":o.get("phone"));
        float f = day / 30;
        int month = 1;
        if (f > 1) {
        ...
        map.put("lease_deposit", o.get("lease_deposit") ==null?"":o.get("lease_deposit")); // 租赁押金
